...
v10 dated 2-7-20
Try to pass in a servo name as parameter.  Success!
...
public class MyBlocks_v10_hardwareMap_OBJ extends BlocksOpModeCompanion {
    ...
    @ExportToBlocks (
    comment = "v10 dated 2-7-2020  Testing hardwareMap, pass the configured device name as a myBlock parameter.",
    tooltip = "Wiggle a user-designated servo, display live status.",
    ...
    public static void wiggleServo (String servoName, int duration, int cycles) {
        ...
        while (!gamepad1.x && !gamepad2.x) {}   // wait for user input
